...
class CompetitionEvaluationTests(unittest.TestCase):
    ...
    def test_web_ui_renders_read_only_evaluation_summary(self):
        ...
        self.assertIn('id="competition-use-case-summary"', html)
        self.assertIn('id="competition-duplicate-effects"', html)
        self.assertIn('id="competition-memory-backend"', html)
        self.assertIn('id="competition-verified-reuse"', html)
        self.assertIn('id="competition-dynamics-mode"', html)
        self.assertIn('id="competition-authority-boundary"', html)
        ...
        self.assertIn("ZERO_WRITE", script)
        self.assertIn("CORE + HUMAN", script)
        self.assertIn("long-running service maintenance", script)
