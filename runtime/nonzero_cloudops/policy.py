...
# Source: cloudops/plan_remediation.py at 4fafed8b1a877e55d96ddd9baea0a737fbeeaa4a.
...
from .investigation import REQUIRED_EC2_TAGS
from .models import (
    CloudFinding,
    CloudResourceType,
    ControlResult,
...
class PlanRemediation:
    ...
    def execute(
        ...
        *,
        ...
        try:
            if len(model_output.encode("utf-8")) > 8192:
                raise ValueError("bounded advisory output exceeded")
