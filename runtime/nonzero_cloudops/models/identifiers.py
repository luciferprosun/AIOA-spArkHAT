...
# Source: nz/identifiers.py at 4fafed8b1a877e55d96ddd9baea0a737fbeeaa4a.
...
from .uuid7 import generate_correlation_id, validate_correlation_id
...
IdempotencyKey = Annotated[
    str,
    StringConstraints(
        min_length=16, max_length=256, pattern=r"^[A-Za-z0-9][A-Za-z0-9._:#/-]*$"
    ),
]
