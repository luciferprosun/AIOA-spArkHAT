...
# Source: domain/errors.py at 4fafed8b1a877e55d96ddd9baea0a737fbeeaa4a.
"""Typed domain errors for explicit failure handling."""

from enum import StrEnum

from .public_enums import ExecutionState
...
class IllegalStateTransitionError(DomainError):
    ...
    def __init__(
        self, current_state: ExecutionState, next_state: ExecutionState
    ) -> None:
