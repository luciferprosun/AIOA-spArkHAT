-- Native C5 unit 0007; reviewed source blob 6141618f70f7c19331bc8b90aec62a3d2a1e68cb.
-- Source namespace/bootstrap is not executed; new native schema and Core context.
CREATE TABLE aioa_memory_patch.ingestions (
 ...
 CHECK ((record_json::JSONB ->> 'kind' = 'ingestion') IS TRUE),
...
-- C5_STATEMENT
ALTER TABLE aioa_memory_patch.ingestions ENABLE ROW LEVEL SECURITY;
-- C5_STATEMENT
ALTER TABLE aioa_memory_patch.ingestions FORCE ROW LEVEL SECURITY;
-- C5_STATEMENT
CREATE INDEX ingestions_state_idx ON aioa_memory_patch.ingestions (tenant_id,owner_id,space_id,slot_id,(record_json::JSONB->'payload'->>'state'),record_id);
