-- Native C5 unit 0015; reviewed source blob 2acc2f052878b4a18c1eb40bd1d2f80fc962fced.
-- Source namespace/bootstrap is not executed; new native schema and Core context.
CREATE TABLE aioa_memory_patch.sharing_proposals (
 ...
 CHECK ((record_json::JSONB ->> 'kind' = 'sharing') IS TRUE),
...
-- C5_STATEMENT
ALTER TABLE aioa_memory_patch.sharing_proposals ENABLE ROW LEVEL SECURITY;
-- C5_STATEMENT
