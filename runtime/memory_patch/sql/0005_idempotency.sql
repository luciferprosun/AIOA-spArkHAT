-- Native C5 unit 0005; reviewed source blob 458c8ff73457d0e59e07a87de89ce25c3350a08f.
-- Source namespace/bootstrap is not executed; new native schema and Core context.
CREATE TABLE aioa_memory_patch.operations (
 ...
 CHECK ((record_json::JSONB ->> 'kind' = 'operation') IS TRUE),
...
-- C5_STATEMENT
ALTER TABLE aioa_memory_patch.operations ENABLE ROW LEVEL SECURITY;
-- C5_STATEMENT
