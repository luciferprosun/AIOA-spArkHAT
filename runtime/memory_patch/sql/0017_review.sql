-- Native C5 unit 0017; reviewed source blob c03c903ce569fb48515ae36f0d24e9c6d3bfc468.
-- Source namespace/bootstrap is not executed; new native schema and Core context.
CREATE TABLE aioa_memory_patch.reviews (
 ...
 CHECK ((record_json::JSONB ->> 'kind' = 'review') IS TRUE),
...
-- C5_STATEMENT
ALTER TABLE aioa_memory_patch.reviews ENABLE ROW LEVEL SECURITY;
-- C5_STATEMENT
