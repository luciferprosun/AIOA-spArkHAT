# AOIA/NMS Grant-Facing Documentation Package

AOIA/NMS is the grant-facing documentation layer for AOIA-Core: a local-first open-source epistemic-control toolkit for AI-assisted development and research workflows.

This package provides a concise reviewer-facing layer for stress-test planning, failure-mode documentation, model-audit review, and a conservative four-month roadmap.
...
- This package does not claim that LSC is validated physics.
- This package does not claim that AOIA/NMS proves LSC.
...
- ../stress_tests/AOIA_NMS_STRESS_TEST_PROTOCOL.md
- ../stress_tests/FAILURE_MODES.md
- ../stress_tests/MODEL_AUDIT_MATRIX.md
- ../ROADMAP_4_MONTHS.md
